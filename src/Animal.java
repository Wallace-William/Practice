...
public class Animal {
    ...
    public void setUniqueID(){ // Method Overloading (Use same name but different parameters)
        long minNumber = 1;
    ...
    public void setFavoriteChar(){
        ...
        //!, &, &&, |, ||, ^
        if((randomNumber > 97) && (randomNumber < 127)){
            System.out.println("Favorite Character is a lowercase letter");
        }
        if(((randomNumber > 97) && (randomNumber < 127)) || ((randomNumber > 64) && (randomNumber < 91))){
